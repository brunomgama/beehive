...
/**
 * Edit Account Desktop Component
        ...
        <div className="sticky top-0 z-50 bg-gradient-to-br from-muted/30 to-background backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-8 pt-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-foreground">Edit Account</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 text-base rounded-xl border-2 bg-white/50 backdrop-blur-sm font-mono"
                    placeholder="PT00 0000 0000 0000 0000 0000 0"
                    required
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={formData.type}
                    onValueChange={(value) => updateField('type', value as AccountType)}
                  >
