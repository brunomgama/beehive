...
const variants = {
  ...
  pending: "bg-gradient-to-br from-pending-start to-pending-end text-white fill-white",
  cancelled: "bg-gradient-to-br from-cancelled-start to-cancelled-end text-white fill-white",
  failed: "bg-gradient-to-br from-failed-start to-failed-end text-white fill-white",
};
