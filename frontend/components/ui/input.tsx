...
function Input({ className, type, borderless, ...props }: InputProps) {
  return (
    <input
      type={type}
      data-slot="input"
      className={cn(
        ...
        "dark:bg-input/30 h-9 w-full min-w-0 rounded-md bg-transparent px-3 py-1 text-base", 
        ...
        !borderless && "border border-input shadow-xs",
