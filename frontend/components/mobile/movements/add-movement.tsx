...
interface AddMovementMobileProps {
  movementId?: number
}

/**
 * Add/Edit Movement Mobile Component
 * Full-page form for creating or editing transactions
 */
export default function AddMovementMobile({ movementId }: AddMovementMobileProps) {
