...
interface EditPlannedMobileProps {
  plannedId: number
}
...
export default function EditPlannedMobile({ plannedId }: EditPlannedMobileProps) {
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-50 bg-background border-b px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Edit Planned</h1>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Next Execution Date */}
          <div className="space-y-2">
            <Label htmlFor="nextExecution" className="text-base font-semibold">Next Execution *</Label>
            <Input
              id="nextExecution"
              type="date"
